...
(function patchEnhanceSystem() {
  ...
  // buildInlineUI chưa tồn tại trong feature_enhance.js — patch còn cần thiết
  if (typeof EnhanceSystem.buildInlineUI === 'function') return;
...
// ===== CHANGES: Xóa console.log hoàn thành; guard `if (typeof EnhanceSystem.buildInlineUI === 'function') return` thay cho if-check lồng toàn bộ nội dung; patch còn nguyên vì buildInlineUI KHÔNG tồn tại trong feature_enhance.js gốc =====
